 ...
 * (`ClaudeProjects`, na přání 21. 9.). Přehled běhů a zásahů Clauda
 * (`RunsHistory`, K3.9) je od 23. 9. v Nastavení → Systém — je to provozní
 * věc, k práci není potřeba. Připnuté pohledy přijdou s K4.2.
 *
